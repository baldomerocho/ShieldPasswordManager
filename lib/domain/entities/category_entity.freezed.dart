...
abstract class $CategoryEntityCopyWith<$Res> {
  ...
  @useResult
  $Res call({String name, String? icon, String id});
}
...
class _$_CategoryEntity implements _CategoryEntity {
  const _$_CategoryEntity({required this.name, this.icon, required this.id});
  ...
  @override
  String toString() {
    return 'CategoryEntity(name: $name, icon: $icon, id: $id)';
  }
...
abstract class _CategoryEntity implements CategoryEntity {
  const factory _CategoryEntity(
      ...
      final String? icon,
      required final String id}) = _$_CategoryEntity;
